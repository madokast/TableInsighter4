...
/**
 * windows error java.lang.UnsatisfiedLinkError: org.apache.hadoop.io.nativeio.NativeIO$Windo
 * @author zhaorx
 */
...
//        private static native NativeIO.POSIX.Stat stat(String var0) throws IOException;
        ...
        private static Stat stat(String var0) throws IOException {
            File f = new File(var0);
            if (f.isFile()) {
                return new Stat(0, 0, 010777);
            } else {
                return new Stat(0, 0, 004777);
            }
        }
